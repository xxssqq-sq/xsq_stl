...
#ifndef XSQ_STL_STL_ITERATOR_BASE_H
#define XSQ_STL_STL_ITERATOR_BASE_H
...
__STL_BEGIN_NAMESPACE
    ...
    template<class Category, class _Tp, class Distance = ptrdiff_t, class Pointer = _Tp *, class _Reference = _Tp &>
    struct iterator {
...
__STL_END_NAMESPACE
#endif //XSQ_STL_STL_ITERATOR_BASE_H
